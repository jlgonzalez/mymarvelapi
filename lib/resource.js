...
var Resource, responseFn, resources, res, fn, lower, merge, checkIdParam

// check if param is ID. If it is, sent just the ID
checkIdParam = function(s) {
...
Resource.prototype.get = function(cb) {
  ...
  uri = this.apiDomain + '/' + this.API_VERSION + '/public/' + lower(checkIdParam(this.resource))
